<%@ Page Title="" Language="C#" MasterPageFile="~/master_pages/MasterPage.master" AutoEventWireup="true" CodeFile="perfiles_detalle.aspx.cs" Inherits="usuarios_Default" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
        <title>Detaller Perfil</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Catalogo de Asignación de modulos a un perfil
                        </h1>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="id" ControlStyle-CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand1">
                                                <Columns>
                                                    <asp:BoundField DataField="id" HeaderText="ID" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                                      <asp:BoundField DataField="Perfil" ItemStyle-HorizontalAlign="Center" HeaderText="Perfil" />
                                                     <asp:BoundField DataField="Modulo" ItemStyle-HorizontalAlign="Center" HeaderText="Modulo">
