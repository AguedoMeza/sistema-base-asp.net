<%@ Page Title="" Language="C#" MasterPageFile="~/master_pages/MasterPage.master" AutoEventWireup="true" CodeFile="usuarios_perfiles.aspx.cs" Inherits="usuarios_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Catalogo de Asignación de perfiles 
                       </h1>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <div class="modal-header">
                                    ...
                                    <h3 id="myModalLabel">Asignación</h3>
                                </div>
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span4 ">
                                                ...
                                                <asp:Panel ID="pn_nombre" runat="server" class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddList_usuarios" runat="server" class="form-control"></asp:DropDownList>
